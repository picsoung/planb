...
module.exports = {
  init: function(cb) {
    ...
    storage.projects.getProjectRoot(function(path) {
      if (path === process.cwd()) {
        console.log("project already initialized")
      } else {
        storage.projects.init(function(err) {
          if (err) console.log("error initializing project", err)
  ...
  add: function(url, cb) {
    ...
    storage.projects.newEndpoint(url, function(err) {
      if (err) {
